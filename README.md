...
| `documentation-technique-bot-rag.pdf` | Documentation technique du bot RAG (architecture, outils utilisés) |

### Code source

| Dossier | Description |
|---------|-------------|
| [`deeply/`](deeply/) | Code source complet de l'application mobile Deeply (Flutter/Dart), déployée sur iOS et Android |
